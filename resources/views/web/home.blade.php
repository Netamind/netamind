...
<head>
    <meta charset="UTF-8">
    <title>Netamind Technology</title>

    <!-- Mobile Specific Metas-->
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    
    <!-- Bootstrap-->
    <link rel="stylesheet" href="theme/stylesheet/bootstrap.css">

    <!-- Template Style-->
    <link rel="stylesheet" href="theme/stylesheet/font-awesome.css">
    <link rel="stylesheet" href="theme/stylesheet/owl.theme.default.min.css">
    <link rel="stylesheet" href="theme/stylesheet/owl.carousel.min.css">
    <link rel="stylesheet" href="theme/stylesheet/animate.css">
    <link rel="stylesheet" href="theme/stylesheet/icomoon.css">
    <link rel="stylesheet" href="theme/stylesheet/jquery-fancybox.css">
    <link rel="stylesheet" href="theme/stylesheet/style.css">
    <link rel="stylesheet" href="theme/stylesheet/shortcodes.css">
    <link rel="stylesheet" href="theme/stylesheet/responsive.css">
    <link rel="stylesheet" href="theme/stylesheet/flexslider.css">
    <link rel="stylesheet" href="theme/rev-slider/css/layers.css">
    <link rel="stylesheet" href="theme/rev-slider/css/navigation.css">
    <link rel="stylesheet" href="theme/rev-slider/css/settings.css">

    <link href="theme/images/icon.jpg" rel="shortcut icon">
...
<body class="counter-scroll">
        ...
        <div class="container">
            <div class="flex-header d-flex">
                <div id="logo" class="logo d-flex align-items-center justify-content-start">
                    <a href="#" title="Logo">
                        <img src="theme/images/netalogo.png" data-width="168" data-height="38" alt="images" data-retina="theme/images/netalogo.png">
                    </a>
                </div>
                <div class="content-menu d-flex align-items-center justify-content-end">
                    <div class="nav-wrap">
                        ...
                        <nav id="mainnav" class="mainnav">
                            <ul class="menu">
                              <li>
                                    <a href="contact.html" class="active">Home</a>
                                </li>    
                                <li>
                                ...
                                <li>
                                    <a href="contact.html">Portifolio</a>
                                </li>    
                                <li>
    ...
    <div class="flat-slider clearfix">
        <div class="rev_slider_wrapper fullwidthbanner-container">
            <div id="rev-slider3" class="rev_slider fullwidthabanner" style="background-color:red">
                <ul>
                    ...
                    <li data-transition="random">
                        <!-- Main Image -->
                        <img src="theme/images/slide2.jpg" alt="" data-bgposition="center center" data-no-retina>
                        <div class="overlay"></div>

                        <!-- Layers -->
                        <div class="tp-caption tp-resizeme text-white text-services-built text-center text-one"
                        ...
                        data-splitin="none" 
                        data-splitout="none" 
                        data-responsive_offset="on">Netamind</div>

                        <div class="tp-caption tp-resizeme text-white text-specifically text-center text-two"
                        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                        ...
                        data-splitin="none" 
                        data-splitout="none" 
                        data-responsive_offset="on">Your partener in digital transformation</div>
                        ...
                        data-responsive_offset="on">
                            <a href="#" class="all-solution font-style linear-color border-corner">Explore our services<span class="icon-arrow-pointing-to-right"></span></a>
                        </div>
                    </li>
                    <!-- /End Slide 1 -->
    ...
    <section class="get-in-touch-type3 get-in-touch-style1 parallax parallax4 position-relative">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <form id="contactform" action="https://themesflat.co/html/softo/contact/contact-process.php" method="post" class="form-git2 form-submit">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="widget-text">
                            <div class="logo"><img src="theme/images/icon.jpg" alt="images"></div>
                            <p>
                                Ut enim ad minim veniam, quis nostrud commodo consequat. Duis aute irure proident, sunt in culpa.
                            </p>
        ...
        <div id="bottom" class="bottom-type3 position-relative">
            <div class="container">
                <div class="bottom-wrap text-center">
                    <div id="copyright">
                        <a href="#">Copyright © 2020 Softo.</a><span class="license"> All Rights Reserved</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="theme/javascript/parallax.js"></script>
    <script src="theme/javascript/plugins.js"></script>
    <script src="theme/javascript/jquery-ui.js"></script>
    <script src="theme/javascript/gmap3.min.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAOvgMzMavm0loFdwqNrzzVh42X_-lDZ3w"></script>
    <script src="theme/javascript/jquery-isotope.js"></script>
    <script src="theme/javascript/owl.carousel.min.js"></script>
    <script src="theme/javascript/equalize.min.js"></script>
    <script src="theme/javascript/jquery-fancybox.js"></script>
    <script src="theme/javascript/jquery-countTo.js"></script>
    <script src="theme/javascript/flex-slider.min.js"></script>
    <script src="theme/javascript/wow.min.js"></script>
    <script src="theme/javascript/jquery-validate.js"></script>
    <script src="theme/javascript/main.js"></script>

    <!-- slider -->
    <script src="theme/rev-slider/js/jquery.themepunch.tools.min.js"></script>
    <script src="theme/rev-slider/js/jquery.themepunch.revolution.min.js"></script>
    <script src="theme/javascript/rev-slider.js"></script>

    <!-- Load Extensions only on Local File Systems ! The following part can be removed on Server for On Demand Loading -->
    <script src="theme/rev-slider/js/extensions/extensionsrevolution.extension.actions.min.js"></script>
    <script src="theme/rev-slider/js/extensions/extensionsrevolution.extension.carousel.min.js"></script>
    <script src="theme/rev-slider/js/extensions/extensionsrevolution.extension.kenburn.min.js"></script>
    <script src="theme/rev-slider/js/extensions/extensionsrevolution.extension.layeranimation.min.js"></script>
    <script src="theme/rev-slider/js/extensions/extensionsrevolution.extension.migration.min.js"></script>
    <script src="theme/rev-slider/js/extensions/extensionsrevolution.extension.navigation.min.js"></script>
    <script src="theme/rev-slider/js/extensions/extensionsrevolution.extension.parallax.min.js"></script>
    <script src="theme/rev-slider/js/extensions/extensionsrevolution.extension.slideanims.min.js"></script>
    <script src="theme/rev-slider/js/extensions/extensionsrevolution.extension.video.min.js"></script>
</body>
</html>
